...
public class MotorStuffExpo {
     ...
     */
    public MotorStuffExpo(HardwareChassisIdeenExpo hwchss, HardwareMap hardwareMap, LinearOpMode opMode) {
        this.hwchss = hwchss;
    ...
    public MotorStuffExpo(HardwareChassisIdeenExpo hwchss) {
        this.hwchss = hwchss;
    }
    /**
